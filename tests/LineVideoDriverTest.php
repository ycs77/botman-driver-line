...
class LineVideoDriverTest extends PHPUnit_Framework_TestCase
{
    /**
     * Get correct Line request data for videos.
     *
     * @return array
     */
    ...
    private function getDriver($responseData, $htmlInterface = null)
    {
        ...
        return new LineVideoDriver($request, [], $htmlInterface);
    }
    ...
    public function it_returns_the_driver_name()
    {
        ...
        $this->assertSame('LineVideo', $driver->getName());
    }
    ...
    public function it_returns_location_from_request()
    {
        ...
        $this->assertEquals('http://line.com/video.mp4', $videos[0]->getUrl());
        $this->assertEquals([
            'url' => 'http://line.com/video.mp4',
        ], $videos[0]->getPayload());
    }
