...
class LineLocationDriverTest extends PHPUnit_Framework_TestCase
{
    /**
     * Get correct Line request data for location.
     *
     * @return array
     */
    ...
    private function getDriver($responseData, $htmlInterface = null)
    {
        ...
        return new LineLocationDriver($request, [], $htmlInterface);
    }
    ...
    public function it_returns_the_driver_name()
    {
        ...
        $this->assertSame('LineLocation', $driver->getName());
    }
