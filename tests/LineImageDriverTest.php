...
class LineImageDriverTest extends PHPUnit_Framework_TestCase
{
    /**
     * Get correct Line request data for images.
     *
     * @return array
     */
                            ...
                            'message' => [
                                ...
                                'attachments' => [
                                    [
                                        'type' => 'image',
                                        'payload' => [
                                            'url' => 'http://lineimage.com/image.png',
                                        ],
                                    ],
                                    [
                                        'type' => 'image',
                                        'payload' => [
                                            'url' => 'http://lineimage.com/imageX.png',
                                        ],
                                    ],
                                ],
                            ],
    ...
    private function getDriver($responseData, $htmlInterface = null)
    {
        ...
        return new LineImageDriver($request, [], $htmlInterface);
    }
    ...
    public function it_returns_the_driver_name()
    {
        ...
        $this->assertSame('LineImage', $driver->getName());
    }
    ...
    public function it_returns_location_from_request()
    {
        ...
        $this->assertEquals('http://lineimage.com/image.png', $images[0]->getUrl());
        $this->assertEquals([
                'url' => 'http://lineimage.com/image.png',
        ], $images[0]->getPayload());

        $this->assertEquals('http://lineimage.com/imageX.png', $images[1]->getUrl());
        $this->assertEquals([
                'url' => 'http://lineimage.com/imageX.png',
        ], $images[1]->getPayload());
    }
